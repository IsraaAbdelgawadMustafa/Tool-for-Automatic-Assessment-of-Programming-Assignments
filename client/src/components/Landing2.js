...
////////////////////////////////////////////Sending code to REST API///////////////////////////////////////////////
  ...
  const handleSendSourceCode = async () => {
    ...
    try{
    const response = await fetch('http://localhost:3000/code/post',
    {
      method:'POST',
      headers: {
        'Content-Type':'application/json'
...
/////////////////////////////BUTTON////////////////////////////////////////////////////
  ...
  const handleESLINTClick = () => {
    // window.open('http://localhost:3000/lintingResults.html');
    window.open("http://localhost:3000/lintingResults.html", "_blank");
  };

  const handlePlatoClick =() =>{
    window.open("http://localhost:3000/plato-output/index.html", "_blank");
  };
...
const sendToJSFile = async() =>{
  try{
    const response = await fetch('http://localhost:3000/code/jsFile',
    {
      method:'POST',
      headers: {
        'Content-Type':'application/json'
...
const testCasesCheck = async() =>{
  try{
    const response = await fetch('http://localhost:3000/code/testCode2',
    {
      method:'POST',
      headers: {
        'Content-Type':'application/json'
  ...
  return (
    ...
    <style>{styles}</style>
     <header class="header">
      ...
      <br></br>
      <h1 className="font-bold px-10 py-1 rounded-md bg-gray-100" style={{ fontFamily: 'Arial, sans-serif', fontSize: '2rem' }}> Assignment 2: Write a program that returns the sum of two numbers 2 and 5. </h1>
      <br></br>
        ...
        <div className="right-container flex flex-shrink-0 w-[30%] flex-col">
          ...
          <div className="flex flex-col items-end">
           ...
           <div  className={classnames(
            ...
            <button onClick={handleESLINTClick}>Show Code Style Feedback</button>
          </div>
          <div  className={classnames(
              "mt-4 border-2 border-black z-10 rounded-md shadow-[5px_5px_0px_0px_rgba(0,0,0)] px-4 py-2 hover:shadow transition duration-200 bg-white flex-shrink-0",
              !code ? "opacity-50" : ""
